...
public class ExtractSrcAftifacts {

		public static void extract(final Set<Artifact> artifacts, final String scope, File outputDirectory) throws ZipException, IOException {
			Set<Artifact> filteredArtifacts = filterArtifactList(artifacts, scope, "zip");
			extractSet(filteredArtifacts, outputDirectory);
		}
		
		private static void extractSet(Set<Artifact> filteredArtifacts, File outputDirectory) throws ZipException, IOException {
