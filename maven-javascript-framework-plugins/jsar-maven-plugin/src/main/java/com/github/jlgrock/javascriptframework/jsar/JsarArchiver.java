...
/**
 * Essentially a copy of the Jar Archiver from the maven-jar-plugin, since due to Plexus
 * there is no way to extend a class in an external maven plugin.
 *
 */
public class JsarArchiver {
...
*/
    ...
    public void createArchive( MavenProject project, MavenArchiveConfiguration archiveConfiguration, String debugFilename )
        throws ArchiverException, ManifestException, IOException, DependencyResolutionRequiredException
    {
        ...
        if ( archiveConfiguration.isAddMavenDescriptor() )
        {
            ...
            new JsarPropertiesUtil().createPomProperties( workingProject, archiver, pomPropertiesFile, forced, debugFilename );
        }
